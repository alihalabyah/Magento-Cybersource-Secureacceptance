 ...
 */
class Cybersource_Secureacceptance_ProcessController extends Mage_Core_Controller_Front_Action
{
    protected $_order;
    ...
    {
        return Mage::getSingleton('secureacceptance/secureacceptance');
    }
	...
	public function redirectAction()
	{
		...
		$this->getResponse()
			->setBody(
				$this->getLayout()->createBlock('secureacceptance/redirect')->setOrder($order)->toHtml()
			);
    }

    public function ipnAction()
    {
	   $helper				= Mage::helper('secureacceptance');
